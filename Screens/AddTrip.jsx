   ...
   Alert.alert(
    ...
    return (
        <ScreenWrapper className="flex-1">
            ...
            <TouchableOpacity onPress={handleAddTrip} style={{backgroundColor: colors.button}} className="flex justify-center rounded-full my-6 p-3 shadow-sm mx-2">
                <Text className={`font-bold text-white text-lg text-center`}>Add Trip</Text>
            </TouchableOpacity>
            </View>
        </ScreenWrapper>
    );
